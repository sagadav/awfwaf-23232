...
const styles = {
  "pages/signin.vue": () => import('./signin-styles.MCR4K8Rq.mjs').then(interopDefault),
  "pages/signin.vue?vue&type=style&index=0&scoped=50198710&lang.css": () => import('./signin-styles.MCR4K8Rq.mjs').then(interopDefault),
